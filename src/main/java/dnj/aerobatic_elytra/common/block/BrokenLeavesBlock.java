...
import dnj.aerobatic_elytra.common.tile.BrokenLeavesTileEntity;
 ...
 * @see dnj.aerobatic_elytra.client.block.ModBlockColors
 */
	...
	public void onEntityCollision(
	  @NotNull BlockState state, @NotNull World world, @NotNull BlockPos pos, Entity entity
		...
		entity.setMotionMultiplier(state, new Vector3d(
		  Config.broken_leaves_motion_multiplier,
		  Config.broken_leaves_motion_multiplier,
		  Config.broken_leaves_motion_multiplier));
