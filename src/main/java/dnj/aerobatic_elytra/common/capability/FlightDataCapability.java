...
public class FlightDataCapability {
	...
	public static final ResourceLocation ID = prefix("flight_data");
	...
	public static class FlightData implements IFlightData {
		...
		private @Nonnull IFlightMode mode = FlightModes.ELYTRA_FLIGHT;
		
		private final Map<ResourceLocation, FadingTickableSound> flightSounds = new HashMap<>();
