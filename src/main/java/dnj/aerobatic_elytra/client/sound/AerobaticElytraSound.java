...
public class AerobaticElytraSound extends FadingTickableSound {
	...
	public void aerobaticElytraTick(float fade_factor) {
		...
		float pitchTilt = abs(aerobaticData.getTiltPitch() / Config.tilt_range_pitch);
		float rollTilt = abs(aerobaticData.getTiltRoll() / Config.tilt_range_roll);
		float yawTilt = abs(aerobaticData.getTiltYaw() / Config.tilt_range_yaw);
