...
public class FlightModeToastOverlay implements IIngameOverlay {
	public static final String NAME = AerobaticElytra.MOD_ID + ":mode_toast";
	...
	@Override public void render(
	  ForgeIngameGui gui, PoseStack pStack, float partialTick, int width, int height
	) {
