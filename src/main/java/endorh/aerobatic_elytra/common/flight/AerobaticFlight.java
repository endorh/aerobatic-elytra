...
import endorh.aerobatic_elytra.client.sound.AerobaticElytraSound;
import endorh.aerobatic_elytra.client.sound.ModSounds;
import endorh.aerobatic_elytra.client.trail.AerobaticTrail;
...
import endorh.aerobatic_elytra.common.event.AerobaticElytraTickEvent;
import endorh.aerobatic_elytra.common.event.AerobaticElytraTickEvent.Pre;
...
import endorh.aerobatic_elytra.network.AerobaticPackets.DAccelerationPacket;
import endorh.aerobatic_elytra.network.AerobaticPackets.DRotationPacket;
import endorh.aerobatic_elytra.network.AerobaticPackets.DTiltPacket;
...
import static endorh.aerobatic_elytra.common.AerobaticElytraLogic.getAerobaticElytra;
		...
		if (player instanceof ServerPlayerEntity) {
			...
			if (speed_cap > 0
				...
				ITextComponent chatWarning =
				  ttc("aerobatic-elytra.config.warning.speed_cap_broken",
