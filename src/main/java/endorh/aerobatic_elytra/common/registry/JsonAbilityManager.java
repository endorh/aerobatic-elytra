...
import endorh.aerobatic_elytra.common.item.IEffectAbility.EffectAbility;
import endorh.aerobatic_elytra.common.item.IEffectAbility.EffectAbility.Deserializer;
...
public class JsonAbilityManager extends JsonReloadListener {
	...
	public JsonAbilityManager() {
		super(GSON, "aerobatic-elytra-abilities");
	}
